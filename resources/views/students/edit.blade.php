                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('students.update', $student->id) }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $student->name) }}" required autofocus>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="has_parent" id="has_parent" value="{{ old('has_parent', $student->parent ? '1' : '0') }}">
                        </div>
                        ...
                        <div id="parent-fields" class="d-none border p-3 rounded mb-4 bg-light">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('parent_name') is-invalid @enderror" id="parent_name" name="parent_name" value="{{ old('parent_name', $student->parent ? $student->parent->name : '') }}">
                                @error('parent_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-0">
                                ...
                                <input type="email" class="form-control @error('parent_email') is-invalid @enderror" id="parent_email" name="parent_email" value="{{ old('parent_email', $student->parent ? $student->parent->email : '') }}">
                                @error('parent_email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            @if(old('has_parent', $student->parent ? '1' : '0') == '1' || $errors->has('parent_name') || $errors->has('parent_email'))
